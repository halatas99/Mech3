...
****************************************************************************
	...
	Ported to the P89LPC9351 microcontroller using C51 by:
...
unsigned char delay=((XTAL/7373000L)*40);
...
{
	printf("Not running under the debugger!\n");
	while(1);
}
...
unsigned char init (void)
{
	...
	BRGCON=3;
	SCON=0x52;
	//Since we are using the UART, enable the TxD and RxD pins!
	P1M1=0;
	P1M2=0;
	//Enable our 'random' number generator
	TR0=0;
