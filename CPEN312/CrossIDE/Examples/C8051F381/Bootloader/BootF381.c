//  C8051F380/C8051F381 (64k Flash) bootloader
//  Copyright (c) 2008-2014 Jesus Calvino-Fraga
//  Compile with C51 using ~C51~  --acall-ajmp --code-loc 0xfa00 --code-size 0x200
//  Always make sure that this bootloader fits in one page (512 bytes)

#define BOOT_START 0xfa00
...
// On power-on reset, jump to the bootloader at address 0xfa00
void bootloader (void) _naked
{
	_asm
		CSEG at 0x0000
	    ljmp BOOT_START
	    CSEG at 0xfbff ; Lock byte location
