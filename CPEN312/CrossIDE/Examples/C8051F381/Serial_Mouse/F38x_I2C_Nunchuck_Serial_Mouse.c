// F38x_I2C_Nunchuck_Serial_Mouse.c: Reads the WII nunchuck using the hardware I2C port
// available in the C8051F38x and reports it so to behave as a serial mouse.  This version
// uses the RTS# signal to determine when to send the mouse ID.
//
