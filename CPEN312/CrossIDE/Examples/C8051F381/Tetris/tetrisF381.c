...
****************************************************************************
	...
	Burn or flash tetrisF381.hex into your C8051F381 microcontroller.
...
unsigned char _c51_external_startup(void)
{
    ...
    PCA0MD&=0xbf; //clear Watchdog Enable bit

	VDM0CN = 0x80; // enable VDD monitor
	RSTSRC = 0x02|0x04; // Enable reset on missing clock detector VDD
