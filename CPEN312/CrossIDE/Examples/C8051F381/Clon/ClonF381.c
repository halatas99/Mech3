// clon.c: This program copies the entire flash memory from one C8051F381 to another
//
// (c) 2008-2014, Jesus Calvino-Fraga
//
// Pin connections (LQFP32 packages):
//    Source C8051F381:    Connects to:
//    P1.0 (26)        ->  C2CK (9) of target C8051F381
//    P1.1 (25)        ->  C2D (10) of target C8051F381
//    P1_2 (24)        ->  The go push-button.  Press to start clonning!
//    P1_3 (23)        ->  To 330 ohms + LED + base of pnp.  Emmiter to 5V, collector to REGIN (7) of target C8051F381
//    P1_4 (22)        ->  Green LED + 330 ohms to 5V
//    P1_5 (21)        ->  Red LED + 330 ohms to 5V
//    REGIN (7)        ->  5V from voltage regulator + 0.1uF + 1.0uF in parallel
//    DGND  (3)        ->  GND (3) target C8051F381
...
// Debug adapter header for the source C8051F381 (top view):
//          +---+---+
//       NC | 1 | 2 | NC
//          +---+---+
//       NC | 3 | 4 | C2D (10)
...
// C2CK (9) | 7 | 8 | NC
//          +---+---+
//  GND (3) | 9 | 10| USB power (5V) not used, but can power the source C8051F381 (pin 7)
//          +---+---+
...
void main (void)
{
	...
	printf("\x1b[2JC8051F380/C8051F381 Clonner.\n"
	...
	while(1)
	{
		...
		printf("Checking for C8051F380/C8051F381 microcontroller...");
		if (j != C8051F38x_ID)
		{
			printf("\nERROR: C8051F380/C8051F381 device not present!\n");
			RLED=LEDON;
			goto the_end;
		}
		printf(" Done.\n");
		...
		YLED=LEDON;
		C2_Reset();
		printf("The YELLOW LED connected to the target C8051F381 should be blinking.\n\n");
